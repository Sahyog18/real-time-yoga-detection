...
if pose_type == 'Anjaneyasana':
    st.image('img/Anjaneyasana.jpg', width=600)
elif pose_type == 'Katichakrasana':
    st.image('img/katichakrasana.png', width=600)
elif pose_type == 'Padmasana':
    st.image('img/padmasana.jpg', width=600)
elif pose_type == 'Trikonasana':
    st.image('img/trikonasana.jpeg', width=600)
elif pose_type == 'Vrkasana':
    st.image('img/vrkasana.jpg', width=600)
